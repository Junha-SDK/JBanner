...
public class JBannerTableViewCell: UITableViewCell {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(JBannerCell.self,
                                forCellWithReuseIdentifier: JBannerCell.identifier)
        return collectionView
    }()
    
    private lazy var indicatorView: JIndicatorView = {
        guard let viewModel = bannerModel else { return JIndicatorView(viewModel: bannerModel!) }
        let indicatorView = JIndicatorView(viewModel: viewModel)
...
@available(iOS 13.0, *)
extension JBannerTableViewCell: UICollectionViewDelegateFlowLayout {
...
@available(iOS 13.0, *)
extension JBannerTableViewCell: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView,
        ...
        guard let cell = collectionView.dequeueReusableCell(
            withReuseIdentifier: JBannerCell.identifier,
            for: indexPath
        ) as? JBannerCell else {
...
@available(iOS 13.0, *)
extension JBannerTableViewCell {
